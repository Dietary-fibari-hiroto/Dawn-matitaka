    ...
    return (
        <div className={`w-[100vw] overflow-x-hidden`}>
            ...
            <section className={`relative section-frame top-background text-white `} style={{ backgroundImage: `url(${ImagesRoutes.manami_hydoro})`, backgroundPosition: '50% 45%' }}>
                <div className={`absolute z-[20] right-[15%] top-[50%] translate-y-[-50%] VDL-PenLetter text-[50px] max-sm:top-[30%] max-sm:right-[10%]`}>
                    <div className="relative flex justify-center items-start w-[200px] h-[300px] ">
                        ...
                        <p className={`absolute top-0 left-0  text-vertical title-bg-style`}>街角の</p>
                        <p className={`ml-[50px] text-vertical title-bg-style`}>たからもの。</p>
                        <p className={`absolute bottom-0 right-0 text-vertical title-bg-style string-ss tracking-[5px] `}>Photo portfolio</p>
            ...
            <section className={`relative section-frame flex-all-center VDL-PenLetter text-black`}>
                ...
                <p className={`useAO ${AOStyle} string-rg z-[5]  overflow-x-hidden `}>街角のたからもの</p>
            </section>
            {/** EXSANPLE */}
            <section className={`relative flex justify-around items-center space-y-[10px] max-sm:flex-col`}>
                ...
                <div className={`space-y-[50px] z-[6] max-sm:order-2`}>
                    <p className={`useAO ${AOStyle} string-md A-OTF-Ryumin-Pr6N-L-KLL heading-title w-[380px]`}>「街角のたからもの」って？</p>
            ...
            {/**ALBUM */}
            <section className={`relative A-OTF-Ryumin-Pr6N-L-KL section-frame flex items-center justify-start overflow-y-hidden`}>
            ...
            <section className={`relative my-[100px] space-y-[10px] flex justify-around items-center max-sm:flex-col`}>
                <div className={`rotating-animation absolute z-[3] top-[50%] left-[30%] w-[300px] h-[150px] bg-gradient-to-b from-[#BC78FF] to-[#3DBBFF] blur-[50px] rounded-[50%] opacity-[50%]`}></div>
                ...
                <div className={`space-y-[50px] z-[6]`}>
